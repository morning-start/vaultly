...
| **生物识别服务** | `lib/core/services/biometric_service.dart` | `BiometricService` |
...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  AuthNotifier(this._authService, this._biometricService) 
  ...
  Future<void> unlockWithBiometric() async {
    ...
    final success = await _authService.unlockWithBiometric();
