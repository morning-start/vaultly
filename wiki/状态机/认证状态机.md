...
| v1.1.0 | 2026-02-21 | 移除生物识别相关状态 | Vaultly Team |
...
| EVT-05 | VERIFY_SUCCESS | 验证成功 | - |
| EVT-06 | VERIFY_FAILURE | 验证失败 | reason: String |
| EVT-07 | LOCKOUT | 失败次数超限 | duration: Duration |
| EVT-08 | UNLOCK_TIMEOUT | 锁定时间结束 | - |
| EVT-12 | LOCK | 用户手动锁定 | - |
