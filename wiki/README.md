...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| v1.0.0 | 2026-02-15 | 初始版本，基础文档结构 |
| v2.0.0 | 2026-02-20 | 引入渐进式文档体系，新增功能/需求/架构文档 |
| v2.1.0 | 2026-02-20 | 完善核心文档，补充代码实践亮点、数据流动设计、代码实现映射 |
| v2.2.0 | 2026-02-21 | 移除生物识别功能，统一文档版本规范 |
| v2.2.1 | 2026-02-22 | 优化 wiki 结构，统一所有文档格式和版本规范 |
| v2.3.0 | 2026-02-22 | 同步项目进度：新增 Folder 模型、Password Policy、Repository 层 |
...
| 目录 | 说明 | 文档数量 |
|------|------|---------|
| **功能文档/** | 功能需求、用户场景、验收标准 | 4 |
| **需求文档/** | 数据模型、数据流动、状态管理、接口设计 | 4 |
| **架构文档/** | 多角色视图、技术选型、实现方案 | 1 |
| **数据流动/** | 数据流转时序图、流程说明 | 1 |
| **状态机/** | 状态转换设计、事件定义 | 2 |
| **角色视图/** | 5种角色专属指南 | 2 |
...
### 文档版本规范
- 所有文档包含统一的版本头部信息（版本、日期、作者、文档类型）
- 所有文档包含版本历史表格
- 版本号遵循语义化版本规范（MAJOR.MINOR.PATCH），格式为 vX.X.X
- 每次更新必须记录变更内容
...
| 文档类型 | 适用场景 | 示例 |
|----------|----------|------|
| 功能文档 | 功能需求、用户场景、验收标准 | 用户认证功能.md |
| 需求文档 | 数据模型、数据流动、状态管理 | 用户认证需求.md |
| 架构文档 | 多角色视图、技术选型、实现方案 | 用户认证架构.md |
| 模块文档 | 模块设计、接口定义 | 认证模块.md |
| API 文档 | 服务接口、方法说明 | 认证接口.md |
| 数据文档 | 数据模型、加密结构 | 数据字典.md |
| 状态机文档 | 状态转换、事件定义 | 认证状态机.md |
| 角色视图 | 特定角色的专属指南 | 架构师视图.md |
| 项目文档 | 项目概览、技术栈 | 项目简介.md |
| 计划文档 | 版本规划、任务清单 | 版本规划.md |
| 检查清单 | 安全、性能检查项 | 安全检查清单.md |
...
| 版本 | 日期 | 变更内容 | 作者 |
|------|------|---------|------|
| v2.2.1 | 2026-02-22 | 优化 wiki 结构，统一所有文档格式和版本规范 | Vaultly Team |
| v2.2.0 | 2026-02-21 | 移除生物识别功能，统一文档版本规范 | Vaultly Team |
| v2.1.0 | 2026-02-20 | 完善核心文档，补充代码实践亮点 | Vaultly Team |
| v2.0.0 | 2026-02-20 | 引入渐进式文档体系，新增功能/需求/架构文档 | Vaultly Team |
| v1.0.0 | 2026-02-15 | 初始版本，基础文档结构 | Vaultly Team |
