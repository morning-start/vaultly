...
import '../../tools/password_policy.dart';
import '../../../shared/widgets/secure_text_field.dart';
import '../../tools/presentation/password_strength_indicator.dart';
import '../../tools/presentation/password_suggestions_widget.dart';
...
class _SetupPasswordPageState extends ConsumerState<SetupPasswordPage> {
  ...
  Future<void> _setupPassword() async {
    ...
    final password = _passwordController.text;
    final success =
        await ref.read(authNotifierProvider.notifier).setupPassword(password);
